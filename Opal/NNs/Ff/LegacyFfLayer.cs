...
public class LegacyFfLayer<TWeights, TBiases, TInput, TOutput> : ILayer<TInput, TOutput> 
    where TInput : notnull where TOutput : notnull
{
    ...
    public LegacyFfLayer(int[] inputShape, int[] outputShape, ActivationFunction<TOutput> activation, 
