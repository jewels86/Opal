...
{
	public class NextWordGenerationModuleLegacy : IModule
	{
		...
		public double K { get; private set; } = 0.2;
		...
		public NextWordGenerationModuleLegacy(string? name = null, SemanticInterpreterModule? semanticInterpreterModule = null)
		{
